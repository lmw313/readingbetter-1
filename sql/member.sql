...
insert into member values(seq_member.nextval, 'test03', 'aaaa', 'test03', 'test03@naver.com', '0100000000', 1, 0, #{grade}, #{classNo}, 0, (select no from school where title=#{schoolName}));
select * from member;
commit;
